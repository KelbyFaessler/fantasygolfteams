...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [
            "bbmajors_compute\\compute_engine\\engine\\Key.cpp",
            "bbmajors_compute\\compute_engine\\engine\\Player.h",
            "bbmajors_compute\\compute_engine\\engine\\Team.cpp",
            "bbmajors_compute\\compute_engine\\engine\\Team.h",
            "bbmajors_compute\\compute_engine\\engine\\main.cpp"
        ],
        "include_dirs": [
            "bbmajors_compute/compute_engine/engine",
            ".\\bbmajors_compute\\compute_engine\\engine"
        ],
        "language": "c++",
        "name": "bbmajors_compute.compute_engine.engine.compute_cpp",
        "sources": [
            "bbmajors_compute/compute_engine/engine/compute_cpp.pyx"
        ]
    },
    "module_name": "bbmajors_compute.compute_engine.engine.compute_cpp"
}
END: Cython Metadata */
...
#define __PYX_HAVE__bbmajors_compute__compute_engine__engine__compute_cpp
#define __PYX_HAVE_API__bbmajors_compute__compute_engine__engine__compute_cpp
/* Early includes */
#include "ios"
#include "new"
#include "stdexcept"
...
/* Module declarations from 'bbmajors_compute.compute_engine.engine.compute_cpp' */
...
#define __Pyx_MODULE_NAME "bbmajors_compute.compute_engine.engine.compute_cpp"
extern int __pyx_module_is_main_bbmajors_compute__compute_engine__engine__compute_cpp;
...
static const char __pyx_k_results_vector[] = "results_vector";
static const char __pyx_k_cline_in_traceback[] = "cline_in_traceback";
static const char __pyx_k_CalculateCombinationsCpp[] = "CalculateCombinationsCpp";
static const char __pyx_k_bbmajors_compute_compute_engine[] = "bbmajors_compute\\compute_engine\\engine\\compute_cpp.pyx";
static const char __pyx_k_bbmajors_compute_compute_engine_2[] = "bbmajors_compute.compute_engine.engine.compute_cpp";
static PyObject *__pyx_n_s_CalculateCombinationsCpp;
static PyObject *__pyx_kp_u_UTF_8;
static PyObject *__pyx_kp_s_bbmajors_compute_compute_engine;
static PyObject *__pyx_n_s_bbmajors_compute_compute_engine_2;
static PyObject *__pyx_n_s_birdie_avg;
static PyObject *__pyx_n_u_birdie_avg;
...
static PyObject *__pyx_pf_16bbmajors_compute_14compute_engine_6engine_11compute_cpp_CalculateCombinationsCpp(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_players_list, PyObject *__pyx_v_num_teams); /* proto */
...
/* Python wrapper */
static PyObject *__pyx_pw_16bbmajors_compute_14compute_engine_6engine_11compute_cpp_1CalculateCombinationsCpp(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_16bbmajors_compute_14compute_engine_6engine_11compute_cpp_1CalculateCombinationsCpp = {"CalculateCombinationsCpp", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_16bbmajors_compute_14compute_engine_6engine_11compute_cpp_1CalculateCombinationsCpp, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_16bbmajors_compute_14compute_engine_6engine_11compute_cpp_1CalculateCombinationsCpp(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyObject *__pyx_v_players_list = 0;
  PyObject *__pyx_v_num_teams = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("CalculateCombinationsCpp (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_players_list,&__pyx_n_s_num_teams,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_players_list)) != 0)) kw_args--;
    ...
    __pyx_v_players_list = values[0];
    __pyx_v_num_teams = values[1];
  }
  ...
  __pyx_r = __pyx_pf_16bbmajors_compute_14compute_engine_6engine_11compute_cpp_CalculateCombinationsCpp(__pyx_self, __pyx_v_players_list, __pyx_v_num_teams);
...
static PyObject *__pyx_pf_16bbmajors_compute_14compute_engine_6engine_11compute_cpp_CalculateCombinationsCpp(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_players_list, PyObject *__pyx_v_num_teams) {
  std::vector<struct Player>  __pyx_v_players_vector;
  struct Player __pyx_v_newPlayerCpp;
 ...
 */
  if (likely(PyList_CheckExact(__pyx_v_players_list)) || PyTuple_CheckExact(__pyx_v_players_list)) {
 ...
 */
  ...
  for (;;) {
    if (!(__pyx_t_10 != __pyx_v_results_vector.end())) break;
...
static int __pyx_pymod_exec_compute_cpp(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_compute_cpp},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  {&__pyx_n_s_CalculateCombinationsCpp, __pyx_k_CalculateCombinationsCpp, sizeof(__pyx_k_CalculateCombinationsCpp), 0, 0, 1, 1},
  {&__pyx_kp_u_UTF_8, __pyx_k_UTF_8, sizeof(__pyx_k_UTF_8), 0, 1, 0, 0},
  {&__pyx_kp_s_bbmajors_compute_compute_engine, __pyx_k_bbmajors_compute_compute_engine, sizeof(__pyx_k_bbmajors_compute_compute_engine), 0, 0, 1, 0},
  {&__pyx_n_s_bbmajors_compute_compute_engine_2, __pyx_k_bbmajors_compute_compute_engine_2, sizeof(__pyx_k_bbmajors_compute_compute_engine_2), 0, 0, 1, 1},
  {&__pyx_n_s_birdie_avg, __pyx_k_birdie_avg, sizeof(__pyx_k_birdie_avg), 0, 0, 1, 1},
  {&__pyx_n_u_birdie_avg, __pyx_k_birdie_avg, sizeof(__pyx_k_birdie_avg), 0, 1, 0, 1},
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initcompute_cpp(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initcompute_cpp(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_compute_cpp(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_compute_cpp(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_compute_cpp(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'compute_cpp' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_compute_cpp(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("compute_cpp", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_bbmajors_compute__compute_engine__engine__compute_cpp) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "bbmajors_compute.compute_engine.engine.compute_cpp")) {
      if (unlikely(PyDict_SetItemString(modules, "bbmajors_compute.compute_engine.engine.compute_cpp", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init bbmajors_compute.compute_engine.engine.compute_cpp", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init bbmajors_compute.compute_engine.engine.compute_cpp");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
